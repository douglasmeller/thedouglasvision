...
- **Anotações (feito)**: bloco de notas estilo dontpad — formatação rica, autosave.
  ...
  - **Ainda em aberto**: além do que foi corrigido acima, "deixar mais completa" pode incluir coisas que o Douglas ainda não detalhou (busca por conteúdo? pastas/tags? anexar imagem? histórico de versões?) — perguntar se quer algo além do que já foi feito.
